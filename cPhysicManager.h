...
class cPhysicManager :public Singleton <cPhysicManager>
{
...
public:
	...
	bool IsOverlap( Transform* pTransA, cBoundSphere* pBoundA, Transform* pTransB, cBoundSphere* pBoundB );
	bool IsOverlap( Transform* pTransA, cBoundBox* pBoundA, Transform* pTransB, cBoundBox* pBoundB );
	
	bool IsOverlap( Transform* pTransA, cBoundSphere* pBoundA, Transform* pTransB, cBoundBox* pBoundB );
	bool IsOverlap( Transform* pTransA, cBoundBox* pBoundA, Transform* pTransB, cBoundSphere* pBoundB );
