...
public:
	...
	void LookDirection(const D3DXVECTOR3& dir, Transform* p, const D3DXVECTOR3& up = D3DXVECTOR3(0, 1, 0));
	...
	void LookPosition(const D3DXVECTOR3& pos, Transform* p, const D3DXVECTOR3& up = D3DXVECTOR3(0, 1, 0));
