...
public:
	static LPD3DXEFFECT		m_pTerrainEffect;			//터레인 Effect
...
public:
	...
	void Render( Camera* pCam, cLight_Direction* pDirectionLight, cLight_Direction* pDirectionLight2);
	void Render( Camera* pCam, cLight_Direction* pDirectionLight, cLight_Direction* pDirectionLight2, Camera* pDirectionLightCamera );
	void RenderShadow( Camera* pDirectionLightCam );
