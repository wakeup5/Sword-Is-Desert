...
bool cPhysicManager::IsRayHitBound( 
	...
	Transform* pBoundTrans,  //바운드의 Transform
...
bool cPhysicManager::IsOverlap( Transform* pTransA, cBoundSphere* pBoundA, Transform* pTransB, cBoundSphere* pBoundB )
{
	//월드 구정보를 얻는다.
	D3DXVECTOR3 centerA;
	float radiusA;
...
bool cPhysicManager::IsOverlap( Transform* pTransA, cBoundBox* pBoundA, Transform* pTransB, cBoundBox* pBoundB )
{
	//월드 구정보를 얻는다.
	D3DXVECTOR3 centerA;
	float radiusA;
...
bool cPhysicManager::IsOverlap( Transform* pTransA, cBoundSphere* pBoundA, Transform* pTransB, cBoundBox* pBoundB )
{
	return true;
}
bool cPhysicManager::IsOverlap( Transform* pTransA, cBoundBox* pBoundA, Transform* pTransB, cBoundSphere* pBoundB )
{
	return true;
}
...
bool cPhysicManager::IsBlocking( 
		Transform* pTransA, cBoundSphere* pBoundA, 
		Transform* pTransB, cBoundSphere* pBoundB ,
		float moveFactor )
...
bool cPhysicManager::IsBlocking( 
		Transform* pTransA, cBoundBox* pBoundA, 
		Transform* pTransB, cBoundBox* pBoundB ,
		float moveFactor )
{
	//둘이 충돌되지 않았으면 할필요없다
