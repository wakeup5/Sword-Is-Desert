...
//카메라 소팅을 할꺼니?
void cQuadParticleEmitter::SetCameraSort( Transform* pCameraTrans, bool bSort )
{
...
void cQuadParticleEmitter::StartOneParticle()
{
	...
	m_pPaticles[ m_dwParticleCount ].m_Transform.SetRotateLocal(pTransform->GetWorldRotateQuaternion());
	m_pPaticles[ m_dwParticleCount ].m_Transform.RotateLocal( 
